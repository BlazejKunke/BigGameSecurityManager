...
export const ChatBubbleLeftRightIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.372c-1.131.113-2.097.641-2.693 1.455l-2.097 2.622-2.097-2.622c-.596-.814-1.562-1.342-2.693-1.455l-3.722-.372C3.847 17.1 3 16.136 3 15v-4.286c0-.97.616-1.813 1.5-2.097m16.5 0a2.25 2.25 0 0 0-2.25-2.25H5.25A2.25 2.25 0 0 0 3 8.511" />
  </svg>
);
...
export const Battery75Icon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
...
export const UserPlusIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0ZM3.375 19.5a5.25 5.25 0 0 1 10.5 0v.75a2.25 2.25 0 0 1-2.25 2.25h-6a2.25 2.25 0 0 1-2.25-2.25v-.75Z" />
  </svg>
);
...
export const UsersIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.962c.57-1.031 1.253-1.964 2.062-2.795M15.54 5.23a2.25 2.25 0 0 1 3.22.05l1.687 1.687a2.25 2.25 0 0 1 0 3.182l-1.687 1.687a2.25 2.25 0 0 1-3.22.05l-1.687-1.687a2.25 2.25 0 0 1 0-3.182l1.687-1.687Zm-5.318 5.318a2.25 2.25 0 0 1 3.182 0l1.687 1.687a2.25 2.25 0 0 1 0 3.182l-1.687 1.687a2.25 2.25 0 0 1-3.182 0l-1.687-1.687a2.25 2.25 0 0 1 0-3.182l1.687-1.687ZM12 12.75a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
    </svg>
);
...
export const FlagIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21v-18a.75.75 0 0 1 .75-.75h13.19c.47 0 .937.161 1.29.444l2.262 1.772a.75.75 0 0 1 0 1.218l-2.262 1.772a1.75 1.75 0 0 0-1.29.444H4.5A.75.75 0 0 0 3.75 9v12Z" />
  </svg>
);
